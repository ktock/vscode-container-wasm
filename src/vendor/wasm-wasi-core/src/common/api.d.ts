...
export declare enum PseudoterminalState {
    /**
 ...
 */
export declare namespace OpenFlags {
    /**
     * No flags.
     */
    const none = 0;
...
export declare namespace WasiCoreImpl {
    function create(context: ExtensionContext, processConstructor: new (baseUri: Uri, programName: string, module: WebAssembly.Module | Promise<WebAssembly.Module>, memory: WebAssembly.Memory | WebAssembly.MemoryDescriptor | undefined, options: ProcessOptions | undefined) => InternalWasiProcess, compile: (source: Uri) => Promise<WebAssembly.Module>): Wasm;
}
